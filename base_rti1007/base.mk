...
#
#  $RCSfile: base.mk $ $Revision: 1.58 $ $Date: 2015/11/24 16:32:47MEZ $
...
MATLAB_ROOT_ALT                = C:\MATLAB\R2016a
MATLAB_BIN_ALT                 = C:\MATLAB\R2016a\bin
RELEASE_VERSION                = R2016a
RELEASE_VERSION               := $(RELEASE_VERSION,S'\.'_',W_,LC,S'^r'')
COMPUTER                       = PCWIN64
MODEL                          = base
MODULES                        = base_data.c base_trc_ptr.c rtGetInf.c rtGetNaN.c rt_i32zcfcn.c rt_matrx.c rt_nonfinite.c rt_printf.c 
S_FUNCTIONS                    = TaskSet.c handEnc2JntAng.c rtiethernetdecode.c handTraj.c handJntAngLimit.c handCtrl.c handJntTrq2DA.c handDALimit.c rtiethernetencode.c XYZstageTraj.c XYZstageAngLimit.c XYZstageEnc2JntAng.c XYZstageCtrl.c XYZstageTrq2DA.c XYZstageDALimit.c SystemSet.c
S_FUNCTIONS_LIB                = 
SOLVER                         = 
NUMST                          = 1
TID01EQ                        = 0
...
# C/CXX: _INLINE is not needed for RTI1007 and is always undefined
